      ...
      <section className="relative hidden overflow-hidden bg-gradient-to-br from-emerald-800 via-emerald-900 to-slate-950 p-12 text-white lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative max-w-xl">
          ...
          <h1 className="mt-4 font-display text-5xl font-black leading-tight tracking-tight">
            Every paddy decision, connected.
          </h1>
          <p className="mt-5 text-base leading-7 text-emerald-100">
            Manage crops and expenses, act on weather alerts, compare market
            prices, and complete direct farmer-to-buyer orders.
          </p>
          <div className="mt-8 grid grid-cols-2 gap-3">
            {[
              [Sprout, 'Crop management'],
              [CloudSun, 'Weather alerts'],
              [TrendingUp, 'Price insights'],
              [ShoppingBag, 'Direct marketplace'],
            ].map(([Icon, text]) => (
              <div
                key={text}
        ...
        <p className="relative text-xs text-emerald-200/60">
          React · FastAPI · MongoDB · S3-ready image storage
        </p>
      </section>
