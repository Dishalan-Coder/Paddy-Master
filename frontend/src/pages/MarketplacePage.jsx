...
export default function MarketplacePage() {
  ...
  const [filters, setFilters] = useState(() => ({
    ...initialFilters,
    variety: searchParams.get('search') || '',
  }));
  ...
  useEffect(() => {
    ...
    setFilters((current) =>
      current.variety === search ? current : { ...current, variety: search },
    );
  }, [searchParams]);
  ...
  const updateFilters = (nextFilters) => {
    ...
    if (nextFilters.variety?.trim())
      nextParams.set('search', nextFilters.variety.trim());
